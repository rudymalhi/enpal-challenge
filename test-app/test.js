...
describe("Coding challenge calendar invalid requests", () => {
	test("Invalid date", async () => {
		try {
			await axios.post("http://localhost:3000/calendar/query", {
				date: "2024-05-51",
				products: ["SolarPanels"],
				language: "German",
				rating: "Bronze",
  ...
  test("Require date", async () => {
	...
	test("Product should be array", async () => {
		try {
			await axios.post("http://localhost:3000/calendar/query", {
				date: "2024-05-51",
				products: "SolarPanel",
